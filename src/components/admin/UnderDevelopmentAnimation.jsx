...
import { Zap, Grid3x3, Code2, Cpu, Workflow } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      <div className="border-b border-gray-200 pb-4 mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Connect with third-party services.</p>
      </div>
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="flex justify-center gap-4 mb-8">
            <div className="relative">
              <Zap size={40} className="text-yellow-500 animate-bounce" style={{ animationDelay: '0s' }} />
            </div>
            <div className="relative">
              <Grid3x3 size={40} className="text-blue-500 animate-bounce" style={{ animationDelay: '0.2s' }} />
            </div>
            <div className="relative">
              <Cpu size={40} className="text-purple-500 animate-bounce" style={{ animationDelay: '0.4s' }} />
            </div>
          </div>
          ...
          <p className="text-gray-700 font-medium mb-2">
            We're building amazing integrations for you
          </p>
          <p className="text-gray-600 text-sm mb-8">
            Tenstreet, Driver Pulse, and others coming soon
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
            {[
              { icon: Code2, label: 'API Integration', delay: '0s' },
              { icon: Workflow, label: 'Workflow Automation', delay: '0.2s' },
              { icon: Zap, label: 'Real-time Sync', delay: '0.4s' },
